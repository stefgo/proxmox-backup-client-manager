...
export const StepConnectionMode = ({ mode, onModeChange }: StepConnectionModeProps) => (
    <div className="space-y-4">
        ...
        <p className="text-xs text-text-muted">
            ...
            question, and no part of this wizard: an SSH reverse tunnel is added from the
            client list afterwards, works with either mode, and each backup job and restore
            decides for itself whether to take it.
        </p>
        <p className="text-xs text-text-muted">
